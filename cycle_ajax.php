...
$html .= "<td><input id='filter' name='filter' type='textbox' title='Enter Regular Expression Match (only alpha, numeric, and special characters \"(^_|?)\" permitted)' size='60' onkeypress='processReturn(event)' value='" . $filter . "'></td>";

$html .= "<td><input type='button' id='go' value='Set' name='go' title='Set Filter'></td><td><input type='button' id='clear' value='Clear' name='clear' title='Clear Filter' onClick='clearFilter()'></td>";
